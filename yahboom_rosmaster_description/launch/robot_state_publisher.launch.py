...
def process_ros2_controllers_config(context):
    ...
    with actual configuration, and writes the processed file to the install directory.
    ...
    pkg_share = get_package_share_directory('yahboom_rosmaster_description')
    config_path = os.path.join(pkg_share, 'config', robot_name)
    ...
    # Write processed content to install directory
