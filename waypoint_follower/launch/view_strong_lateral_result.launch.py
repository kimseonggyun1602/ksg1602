...
def generate_launch_description():
    ...
    default_results = os.path.expanduser(
        '~/ksg_results/strong_lateral_wheel_only')
    ...
    return LaunchDescription([
        ...
        Node(
            ...
            name='saved_strong_result_viewer',
            output='screen',
            parameters=[{
        ...
        Node(
            package='rviz2',
            executable='rviz2',
            name='rviz_saved_strong_result_viewer',
            output='screen',
            arguments=[
                '-d',
                os.path.join(share, 'rviz', 'strong_saved_result_viewer.rviz'),
            ],
        ),
    ])
