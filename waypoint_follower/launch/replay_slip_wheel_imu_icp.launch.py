...
def generate_launch_description():
    ...
    wheel_odom_degrader = Node(
        ...
        parameters=[
            os.path.join(
                waypoint_share, 'config', 'wheel_odom_drive_slip.yaml'),
            {
    ...
    icp_covariance_scaler = Node(
        ...
        parameters=[{
            ...
            'pose_xy_variance_floor': 0.050,
            'pose_yaw_variance_floor': 0.030,
            'twist_xy_variance_floor': 0.080,
            'twist_yaw_variance_floor': 0.040,
        }],
    )
    ...
    ekf = Node(
        ...
        parameters=[
            os.path.join(
                waypoint_share, 'config', 'ekf_slip_wheel_imu_icp.yaml'),
        ],
        remappings=[
